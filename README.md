...
E --> F{Validar campos vacíos}
F -->|Sí| G[Mostrar mensaje de error (MUI Alert)]
F -->|No| H[Llamar a Firebase Auth con email y password]

H --> I{Firebase valida credenciales}
I -->|Inválidas| J[Mostrar error de autenticación (Snackbar MUI)]
I -->|Válidas| K[Obtener objeto de usuario]
